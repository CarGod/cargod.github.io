...
Six complete locales (Simplified Chinese, Traditional Chinese, English, Japanese, Korean and Spanish), each with one landing page and 72 method pages: 438 routes. Homepages and language switches link to the corresponding locale and preserve the current method. Public repository documentation is available in Chinese and English. Localized examples and methods are editorial adaptations of the public source materials; the skill itself is primarily Chinese.
...
- Static HTML includes all 72 answers and the front/back method content. JavaScript progressively adds selection and flipping; it is not required to retrieve the content.
...
- `npm run test:council` verifies all 438 routes, unique titles, canonical/OG agreement, structured breadcrumbs, sitemap inclusion, referenced method ownership, reciprocal hreflang links, locale completeness, localized homepage links, and six share-image dimensions.
...
Release v2.3.1: 18 perspectives, 72 selected examples and method pages per language; the complete downloadable skill has 255 methods. Canonical Chinese method content is copied from public commit ee26918621ef281ebcdf46c1bc5b0dd7f074134c. Localized descriptions retain applicability and limitations.
